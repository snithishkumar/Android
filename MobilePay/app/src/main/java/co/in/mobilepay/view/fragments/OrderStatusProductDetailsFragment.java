...
public class OrderStatusProductDetailsFragment extends Fragment{
    ...
    private void initView(View view){
        ...
        shopName = (TextView)view.findViewById(R.id.order_status_shop_name);
        shopArea = (TextView)view.findViewById(R.id.order_status_shop_area);
        shoppingDateTime  = (TextView)view.findViewById(R.id.order_status_shop_date_time);
        shopOrderId = (TextView)view.findViewById(R.id.order_status_shop_order_id);
    ...
    private void populatePurchaseData(View view){
       ...
       productDetailsModelList = gson.fromJson(productDetails, new TypeToken<List<ProductDetailsModel>>() {
        ...
        // Set the adapter
        RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.order_status_shop_product_items_view);
