...
public class NotificationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       int notificationType =  getIntent().getIntExtra("notificationType",1);
        Log.i("Noti","notificationType"+notificationType);
         purchaseUuid = getIntent().getStringExtra("purchaseUuid");
        Log.i("purchaseUuid","purchaseUuid"+purchaseUuid);
        callActivity(notificationType,purchaseUuid);

    }


    private void callActivity(int notificationType,String purchaseUuid){
        try{
