...
public enum ServiceAPI {
    ...
    ServiceAPI(){
        ...
        Retrofit retrofit = new Retrofit.Builder().baseUrl("http://192.168.0.8:8080/mobilepay/").addConverterFactory(GsonConverterFactory.create()).callbackExecutor(executor).build();
