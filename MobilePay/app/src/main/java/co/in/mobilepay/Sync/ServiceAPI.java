...
public enum ServiceAPI {
    ...
    ServiceAPI(){
        ...
        Retrofit retrofit = new Retrofit.Builder().baseUrl("http://192.168.0.11:8081/mobilepay/").addConverterFactory(GsonConverterFactory.create()).callbackExecutor(executor).build();
